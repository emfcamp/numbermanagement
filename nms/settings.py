...
SECRET_KEY = 'django-insecure-^@#n!-t)tzwaq2sk)!(7h1!7xxe8fqcin44!wnfi=u7=-td14s'
...
DYNAMIC_FORMS_CUSTOM_JS = 'console.log("Custom Form")'
...
# Hookdeck Settings for Publishing Events
HOOKDECK_URL = env('HOOKDECK_URL')
HOOKDECK_TOKEN = env('HOOKDECK_TOKEN')
...
# Email Verification Templates  (in main templates folder)
HTML_MESSAGE_TEMPLATE = "email_verification_msg.html"
VERIFICATION_SUCCESS_TEMPLATE = 'email_verification_success.html'
